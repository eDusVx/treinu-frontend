                  ...
                  >
                    ...
                    {ex.arquivoDemonstracao ? (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="aspect-video bg-[#0d100e] flex items-center justify-center relative overflow-hidden group cursor-pointer block"
                        title="Ver demonstração"
                      >
                        {isDirectImage(ex.arquivoDemonstracao) ? (
                          <img
                          ...
                          />
                        ) : isYoutube(ex.arquivoDemonstracao) ? (
                          <img
                          ...
                          />
                        ) : isDirectVideo(ex.arquivoDemonstracao) ? (
                          <video
                            src={ex.arquivoDemonstracao}
                            className="w-full h-full object-cover"
                            preload="metadata"
                        ...
                        {(isYoutube(ex.arquivoDemonstracao) || isDirectVideo(ex.arquivoDemonstracao)) && (
